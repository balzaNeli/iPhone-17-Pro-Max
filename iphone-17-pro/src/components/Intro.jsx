    ...
    return(
        <section className="bg-black py-20 px-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-16">
                ...
                <button className="border-2 border-white rounded-full hover:bg-white hover:text-black px-8 py-4 transition-all duration-300 text-lg font-medium hover:scale-105 shadow-lg shadow-amber-900/50 cursor-pointer">Saiba mais</button>
            </div>

            <div className="grid grid-cols2 md:grid-cols4 gap-6 mx-auto max-w-3xl">
